...
/* ---------------------  NAVBAR -------------------------- */
  ...
  if ($loggedin)
  {  
  echo '<nav class="navbar navbar-expand-lg navbar-dark brown-dms" >
            ...
            <div class="row">
               <div class="col-sm-6 dashboard2 py-3 pr-2">
                 <div class="dashboard-header2 p-2 rounded">
                    <a data-toggle="collapse" href="#Env" aria-expanded="false" aria-controls="Env"><h4>Environments <i class="fa fa-caret-down"></i></h4></a>
                     <div class="collapse" id="Env">';

/* ------  ADD ENVIRONMENT ------ */

echo                 '<a data-toggle="collapse" href="#MacEnvForm" aria-expanded="false" aria-controls="MacEnvForm">Add Environment <i class="fa fa-caret-down"></i></a>
...
for ($j = 0; $j<$rows ; ++$j){
    ...
    $EnvType = $row['envtype'];
    $EnvDesc = $row['envdesc'];
    echo "<div><a data-toggle='collapse' href='#MacEnv$j' aria-expanded='false' aria-controls='MacEnv$j'>$EnvName ($EnvType)<i class='fa fa-caret-down'></i></a></div>";
...
for ($j = 0; $j<$rows ; ++$j){
    ...
    $EnvType = $row['envtype'];
    $EnvDesc = $row['envdesc'];
    echo "<div><a data-toggle='collapse' href='#MicEnv$j' aria-expanded='false' aria-controls='MicEnv$j'>$EnvName ($EnvType)<i class='fa fa-caret-down'></i></a></div>";
